package com.example.javafxhttpclient.demo.brackethighlighter;
...
public class BracketHighlighterDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        scene.getStylesheets().add(BracketHighlighterDemo.class.getResource("/com/example/javafxhttpclient/demo/brackethighlighter/bracket-highlighter.css").toExternalForm());
