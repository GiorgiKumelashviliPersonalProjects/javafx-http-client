package com.example.javafxhttpclient.demo.hyperlink;
...
public class TextHyperlinkArea extends GenericStyledArea<Void, Either<String, Hyperlink>, TextStyle> {
    ...
    public TextHyperlinkArea(Consumer<String> showLink) {
        ...
        getStylesheets().add(TextHyperlinkArea.class.getResource("/com/example/javafxhttpclient/demo/hyperlink/text-hyperlink-area.css").toExternalForm());
    }
