...
package com.example.javafxhttpclient.demo.richtext;
...
public class RichTextDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        scene.getStylesheets().add(RichTextDemo.class.getResource("/com/example/javafxhttpclient/demo/richtext/rich-text.css").toExternalForm());
